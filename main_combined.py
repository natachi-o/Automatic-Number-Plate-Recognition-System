...
licence_plate_detector = YOLO("license_plate_detector.pt")
...
while ret:
    ...
    if ret and frame_number % 3 == 0:  # Frame skipping
        ...
        for licence_plate in licence_plates.boxes.data.tolist():
            ...
            if car_id != -1:
                ...
                # Save the processed license plate image to a file
        ...
        for licence_plate in licence_plates.boxes.data.tolist():
            x1, y1, x2, y2, score, class_id = licence_plate
            cv2.rectangle(frame, (int(x1), int(y1)), (int(x2), int(y2)), (0, 0, 255), 2)  # red rectangle for license plates
